...
def menu():
	...
	info_rect = render_text("INFO", 300, 250, color=(241, 232, 205), size=25)
	board_rect = render_text("BOARD EDITOR", 430, 350, color=(241, 232, 205), size=25)
	if game_mode == 1:
		game_mode_rect = render_text("GAME MODE [PVP]", 400, 450, color=(241, 232, 205), size=25)
	elif game_mode == 2:
		game_mode_rect = render_text("GAME MODE [random]", 400, 450, color=(241, 232, 205), size=25)
	elif game_mode == 3:
		game_mode_rect = render_text("GAME MODE [easy]", 400, 450, color=(241, 232, 205), size=25)
	elif game_mode == 4:
		game_mode_rect = render_text("GAME MODE [normal]", 400, 450, color=(241, 232, 205), size=25)
	elif game_mode == 5:
		game_mode_rect = render_text("GAME MODE [hard] - beta", 400, 450, color=(241, 232, 205), size=25)

	play_rect = render_text("PLAY", 330, 300, color=(241, 232, 205), size=25)
